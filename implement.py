    ...
    while True:
        ...
        if menu == 1:
            ...
            if servicio_hospitalario.verificarExiste(historia) == False:
                ...
                print(
                    "Ya existe una mascota con el numero de historia clínica ingresado.")
            ...
            if fecha != None:
                ...
                print(
                    "La historia clínica ingresada no corresponde con ninguna mascota en el sistema.")
            ...
            if medicamento != None:
                print(
                    f"El medicamento suministrado es: {medicamento.verNombre()} con dosis {medicamento.verDosis()}")
            else:
                print(
                    "La historia clínica ingresada no corresponde con ninguna mascota en el sistema.")
